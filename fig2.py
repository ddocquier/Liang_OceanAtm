...
# File names
filename_liang = dir_output + 'SST_THF_Liang_2var_01.npy'
filename_sig = dir_output + 'SST_THF_Liang_2var_sig_fdr_alpha005.npy'
...
if save_var == True:
    ...
    for i in np.arange(n_iter-1):
        print(i)
        if i < 8:
            filename = dir_output + 'SST_THF_Liang_2var_0' + str(i+2) + '.npy'
        else:
            filename = dir_output + 'SST_THF_Liang_2var_' + str(i+2) + '.npy'
...
# Fig. 2: Relative transfer of information SST-THF
